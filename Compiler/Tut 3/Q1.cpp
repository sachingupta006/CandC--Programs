...
int main()
{
    ...
    set <char> FIRST[no_nonTerminals+no_terminals];   // FIRST set for all terminals and non terminals     
    ...
    char term;
    int index;
    for( index = 0;index < no_terminals;index++)
    {
            cin>>term;
    ...
    {
        cout<<"FIRST set for "<<nonTerminals[l-index]<<":    ";
    ...
    cout<<endl<<"Calculating the FOLLOW set"<<endl;
    ...
    {
        cout<<"FOLLOW set for "<<nonTerminals[l]<<":    ";
